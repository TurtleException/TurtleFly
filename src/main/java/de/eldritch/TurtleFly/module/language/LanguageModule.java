package de.eldritch.TurtleFly.module.language;
...
public class LanguageModule extends PluginModule {
    ...
    private final HashMap<String, HashMap<String, String>> LANG;

    public LanguageModule() throws PluginModuleEnableException {
        super();
    ...
    private void indexLangMap() {
        try {
            for (File langFile : Objects.requireNonNull(new File(TurtleFly.getPlugin().getDataFolder(), "lang").listFiles(File::isFile))) {
